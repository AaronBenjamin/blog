...
def register_template_context(app):
    ...
    def make_template_context():
        ...
        return dict(admin=admin, tags=tags)
...
def register_commands(app):
    ...
    @click.password_option("--password", prompt=True, hide_input=True, confirmation_prompt=True, help='The password userd to login.')
    ...
    def forge(tag, post):
        """Generate fake data."""
        from blog.fakes import fake_admin, fake_tags, fake_posts
